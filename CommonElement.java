 ...
 * increasing** order, return a sorted array of only the integers that appeared
 * in all three arrays.
 * 
 * Example 1:
 * 
...
public class CommonElement {
	...
	private static void findCommonElements(int[] arr1, int[] arr2, int[] arr3) {
		...
		// initialize the array indexes(i,j,k) to 0
		int i = 0, j = 0, k = 0;
	...
	public static void main(String[] args) {
		...
		System.out.println("Common elements present in the given arrays are:");
